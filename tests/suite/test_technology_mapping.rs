...
// (transform_mir_to_lir, TechnologyMapper, TechnologyTarget) which has been replaced
// by the new technology mapping infrastructure (MirToWordLir, TechMapper, MirToGateNetlist).
// TODO: Update these tests to use the new TechMapper and GateNetlist APIs.
