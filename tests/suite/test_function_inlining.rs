...
async fn test_simple_add_function() {
    ...
    tb.export_waveform("build/test_simple_add_function.skw.gz")
        .ok();
}
...
async fn test_simple_sub_function() {
    ...
    tb.export_waveform("build/test_simple_sub_function.skw.gz")
        .ok();
}
...
async fn test_simple_bitwise_and() {
    ...
    tb.export_waveform("build/test_simple_bitwise_and.skw.gz")
        .ok();
}
...
async fn test_multiple_function_calls() {
    ...
    tb.export_waveform("build/test_multiple_function_calls.skw.gz")
        .ok();
}
...
async fn test_nested_function_calls() {
    ...
    tb.export_waveform("build/test_nested_function_calls.skw.gz")
        .ok();
}
...
async fn test_function_in_expression() {
    ...
    tb.export_waveform("build/test_function_in_expression.skw.gz")
        .ok();
}
...
async fn test_function_with_single_let() {
    ...
    tb.export_waveform("build/test_function_with_single_let.skw.gz")
        .ok();
}
...
async fn test_function_with_multiple_lets() {
    ...
    tb.export_waveform("build/test_function_with_multiple_lets.skw.gz")
        .ok();
}
...
async fn test_function_with_dependent_lets() {
    ...
    tb.export_waveform("build/test_function_with_dependent_lets.skw.gz")
        .ok();
}
...
async fn test_function_with_if_expr() {
    ...
    tb.export_waveform("build/test_function_with_if_expr.skw.gz")
        .ok();
}
...
async fn test_function_with_nested_if() {
    ...
    tb.export_waveform("build/test_function_with_nested_if.skw.gz")
        .ok();
}
...
async fn test_function_with_match_expr() {
    ...
    tb.export_waveform("build/test_function_with_match_expr.skw.gz")
        .ok();
}
...
async fn test_function_with_wide_types() {
    ...
    tb.export_waveform("build/test_function_with_wide_types.skw.gz")
        .ok();
}
...
async fn test_function_in_sequential_block() {
    ...
    tb.export_waveform("build/test_function_in_sequential_block.skw.gz")
        .ok();
}
...
async fn test_multiple_functions_same_impl() {
    ...
    tb.export_waveform("build/test_multiple_functions_same_impl.skw.gz")
        .ok();
}
