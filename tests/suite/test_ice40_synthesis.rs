...
use skalp_lir::{
    ...
    lower_mir_module_to_lir, lower_mir_module_to_lir_with_bram, synthesize_for_area,
    synthesize_for_timing, CellFunction, Lir, LirOp,
};
...
impl TestDesign {
    ...
    println!("Balanced preset: {} cells", balanced.netlist.cells.len());
    assert!(
