...
fn test_behavioral_combinational(
    source: &str,
    module_name: &str,
    test_cases: &[(&[(&str, u64, usize)], &[(&str, u64, usize)])],
) {
...
fn test_ncl_behavioral_inverter() {
    ...
    test_behavioral_combinational(source, "NclInverter", &[
        (&[("a", 0, 1)], &[("y", 1, 1)]),
        (&[("a", 1, 1)], &[("y", 0, 1)]),
    ]);
}
...
fn test_ncl_behavioral_and_gate() {
    ...
    test_behavioral_combinational(source, "NclAnd", &[
        (&[("a", 0, 1), ("b", 0, 1)], &[("y", 0, 1)]),
        (&[("a", 0, 1), ("b", 1, 1)], &[("y", 0, 1)]),
        (&[("a", 1, 1), ("b", 0, 1)], &[("y", 0, 1)]),
        (&[("a", 1, 1), ("b", 1, 1)], &[("y", 1, 1)]),
...
fn test_ncl_behavioral_or_gate() {
    ...
    test_behavioral_combinational(source, "NclOr", &[
        (&[("a", 0, 1), ("b", 0, 1)], &[("y", 0, 1)]),
        (&[("a", 0, 1), ("b", 1, 1)], &[("y", 1, 1)]),
        (&[("a", 1, 1), ("b", 0, 1)], &[("y", 1, 1)]),
        (&[("a", 1, 1), ("b", 1, 1)], &[("y", 1, 1)]),
...
fn test_ncl_behavioral_xor_gate() {
    ...
    test_behavioral_combinational(source, "NclXor", &[
        (&[("a", 0, 1), ("b", 0, 1)], &[("y", 0, 1)]),
        (&[("a", 0, 1), ("b", 1, 1)], &[("y", 1, 1)]),
        (&[("a", 1, 1), ("b", 0, 1)], &[("y", 1, 1)]),
        (&[("a", 1, 1), ("b", 1, 1)], &[("y", 0, 1)]),
...
fn test_ncl_behavioral_and_8bit() {
    ...
    test_behavioral_combinational(source, "NclAnd8", &[
...
fn test_ncl_behavioral_or_8bit() {
    ...
    test_behavioral_combinational(source, "NclOr8", &[
        (&[("a", 0x00, 8), ("b", 0x00, 8)], &[("y", 0x00, 8)]),
        (&[("a", 0xFF, 8), ("b", 0xFF, 8)], &[("y", 0xFF, 8)]),
...
fn test_ncl_behavioral_xor_8bit() {
    ...
    test_behavioral_combinational(source, "NclXor8", &[
        (&[("a", 0x00, 8), ("b", 0x00, 8)], &[("y", 0x00, 8)]),
...
fn test_ncl_behavioral_not_8bit() {
    ...
    test_behavioral_combinational(source, "NclNot8", &[
        (&[("a", 0x00, 8)], &[("y", 0xFF, 8)]),
        (&[("a", 0xFF, 8)], &[("y", 0x00, 8)]),
        (&[("a", 0xAA, 8)], &[("y", 0x55, 8)]),
        (&[("a", 0xF0, 8)], &[("y", 0x0F, 8)]),
...
fn test_ncl_behavioral_add_8bit() {
    ...
    test_behavioral_combinational(source, "NclAdd8", &[
        (&[("a", 0, 8), ("b", 0, 8)], &[("sum", 0, 8)]),
        (&[("a", 1, 8), ("b", 1, 8)], &[("sum", 2, 8)]),
...
fn test_ncl_behavioral_sub_8bit() {
    ...
    test_behavioral_combinational(source, "NclSub8", &[
...
fn test_ncl_behavioral_mul_4bit() {
    ...
    test_behavioral_combinational(source, "NclMul4", &[
...
fn test_ncl_behavioral_eq_8bit() {
    ...
    test_behavioral_combinational(source, "NclEq8", &[
        (&[("a", 0, 8), ("b", 0, 8)], &[("eq", 1, 1)]),
...
fn test_ncl_behavioral_lt_8bit() {
    ...
    test_behavioral_combinational(source, "NclLt8", &[
        (&[("a", 0, 8), ("b", 1, 8)], &[("lt", 1, 1)]),
...
fn test_ncl_behavioral_shift_left() {
    ...
    test_behavioral_combinational(source, "NclShl", &[
        (&[("a", 0x00, 8)], &[("y", 0x00, 8)]),
        (&[("a", 0x01, 8)], &[("y", 0x02, 8)]),
        (&[("a", 0x40, 8)], &[("y", 0x80, 8)]),
        (&[("a", 0x55, 8)], &[("y", 0xAA, 8)]),
...
fn test_ncl_behavioral_shift_right() {
    ...
    test_behavioral_combinational(source, "NclShr", &[
        (&[("a", 0x00, 8)], &[("y", 0x00, 8)]),
        (&[("a", 0x02, 8)], &[("y", 0x01, 8)]),
        (&[("a", 0x80, 8)], &[("y", 0x40, 8)]),
        (&[("a", 0xAA, 8)], &[("y", 0x55, 8)]),
...
fn test_ncl_behavioral_mux() {
    ...
    test_behavioral_combinational(source, "NclMux", &[
        (&[("sel", 0, 1), ("a", 42, 8), ("b", 100, 8)], &[("y", 42, 8)]),
        (&[("sel", 1, 1), ("a", 42, 8), ("b", 100, 8)], &[("y", 100, 8)]),
    ]);
}
...
fn test_ncl_behavioral_combined_logic() {
    ...
    test_behavioral_combinational(source, "NclCombined", &[
