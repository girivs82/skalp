...
mod cpu_fp_simulation_tests {
    ...
    async fn test_fp32_addition_cpu() {
        ...
        tb.export_waveform("build/test_fp32_addition_cpu.skw.gz")
            .ok();
    }
    ...
    async fn test_fp32_multiplication_cpu() {
        ...
        tb.export_waveform("build/test_fp32_multiplication_cpu.skw.gz")
            .ok();
    }
    ...
    async fn test_fp32_comparison_cpu() {
        ...
        tb.export_waveform("build/test_fp32_comparison_cpu.skw.gz")
            .ok();
    }
    ...
    async fn test_fp32_negation_cpu() {
        ...
        tb.export_waveform("build/test_fp32_negation_cpu.skw.gz")
            .ok();
    }
}
